...
public class Utilities {
    ...
    public static boolean isAlphaNum(String text)
    {
    ...
    {
        return inputDate.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
    }
    ...
    public static boolean isBetweenDates(LocalDate date, LocalDate before, LocalDate after) {
        return date.isAfter(before) && date.isBefore(after) || (date.equals(before) || date.equals(after)); // equals() to include full date range
    }
    /*
